...
test_wrapped = wrap_text("This is a test of the Waveshare e-Paper display with text wrapping functionality. It should handle long lines and wrap them correctly.", FONT, HEIGHT)
print(test_wrapped)
# Add to test_wrapped
...
test_wrapped
test_wrapped2 = add_to_text_array(test_wrapped, "Press KEY1 to start, KEY2 to exit.")
