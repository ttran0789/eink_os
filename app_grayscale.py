...
def test_pattern():
    try:
        ...
        # Create single grayscale image
        image = Image.new('L', (epd.width, epd.height), 255)  # L mode for grayscale
        draw = ImageDraw.Draw(image)
        
        # Draw test pattern with different gray levels
        draw.rectangle((10, 10, 110, 110), outline=0, fill=200)    # Light gray rectangle  
        draw.rectangle((120, 10, 220, 110), outline=0, fill=100)   # Medium gray rectangle
        draw.rectangle((10, 120, 110, 160), outline=0, fill=50)    # Dark gray rectangle
        draw.line((10, 60, 220, 60), fill=0, width=3)             # Black line
...
def hello_world():
    try:
        ...
        draw.text((10, 90), '4-bit Grayscale', font=font, fill=128)
